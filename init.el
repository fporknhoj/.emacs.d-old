...
(global-set-key "\C-x\C-b" 'buffer-menu);'ibuffer);
1kk
...
;; make c-z the undo instead of minimize
(global-set-key (kbd "C-z") 'undo)

;; maximize window in frame
;; (global-set-key [f1] (kbd "C-u 999 C-x ^"))
   (global-set-key '[f1] '(lambda () (interactive) (enlarge-window 100000)) )

;; add additional shortcut to buffer thing
   (global-set-key [f12] 'ibuffer);;(kbd "C-c C-v") 'buffer-menu)

;; quick way to kill a buffer without a prompt
